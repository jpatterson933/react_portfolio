    ...
    <div className="jumbotron jumbotron-fluid">
        <div className="container">
            ...
            <div className="list-group" id="skills">
                <ListItem name="Known Languages" />
                <ListItem name="HTML" />
                <ListItem name="CSS" />
                <ListItem name="Javascript" />
                <ListItem name="Jquery" />
                <ListItem name="Bootstrap" />
                <ListItem name="Node.js" />
                <ListItem name="Sequelize" />
                <ListItem name="MySQL" />
                <ListItem name="GraphQL" />
                <ListItem name="Apollo" />
                <ListItem name="Mongoose" />
                <ListItem name="Handlebars" />
                <ListItem name="EJS" />
                <ListItem name="React" />
            </div>
        </div>
        ...
        <div className="row">
            <div className="card" >
                ...
                <ul className="list-group list-group-flush cards-list">
                    <li className="list-group-item">Find any Game in the world</li>
                    <li className="list-group-item">Find Game Completion Time</li>
                    <li className="list-group-item">Beat that game</li>
                </ul>
                <div className="col">
